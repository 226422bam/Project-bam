...
export const CartItem = (props) => {
    const { id, image, name, description, size, price } = props.data;
    const { itemCart, addToCart, removeFromCart, updateCart } = useContext(OrderContext);
                ...
                <div className="flex-col justify-center items-center h-full w-full">
                    ...
                    <div className="flex justify-center items-center w-full" style={{ marginTop: '0.5rem' }}>
                        <div className="flex items-center justify-center">
                            ...
                            <input className="w-5 text-center text-red-500" type="text" value={itemCart[id]} onChange={(e) => { updateCart(id, Number(e.target.value)) }} />
                    ...
                    <div className="flex justify-center items-center h-full w-full" style={{ fontSize: '0.8rem', marginTop: '-40px', marginLeft: '-75px' }}>
                        <div className="px-2 py-1 rounded text-red-500" style={{ fontWeight: 'bold' }}>{price} บาท</div>
                    </div>
                </div>
            </div>
        </li>
